      ...
      <main className="vv-section bg-ink text-white">
        <div className="vv-container grid gap-10 lg:grid-cols-[.85fr_1.15fr]">
          <div>
            ...
            <h1 className="text-4xl font-extrabold">Get online guidance or request a Hyderabad home visit.</h1>
            <p className="mt-4 text-slate-300">Vision Vistara operates online with scheduled home visits in selected Hyderabad pincodes. We do not offer walk-ins or a public showroom.</p>
            <div className="mt-8 grid gap-3 text-slate-200">
              <p><strong>Phone / WhatsApp:</strong> {CLINIC_PHONE}</p>
              <p><strong>Service area:</strong> Selected Hyderabad pincodes, confirmed before every order or home visit</p>
