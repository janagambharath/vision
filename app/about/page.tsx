...
export const metadata: Metadata = {
  title: "About",
  description: `Learn about ${CLINIC_NAME} — online prescription guidance, scheduled Hyderabad home visits, and eyewear support.`,
  alternates: { canonical: `${SITE_URL}/about` }
};

export default function AboutPage() {
  return <><SiteHeader /><main>
    <section className="relative isolate overflow-hidden bg-ink text-white"><div className="absolute inset-0 -z-10 bg-[linear-gradient(135deg,rgba(5,9,19,.95),rgba(21,80,184,.4))]" /><div className="vv-container py-24 md:py-32"><p className="mb-4 text-xs font-extrabold uppercase text-cyan-300">About Vision Vistara</p><h1 className="max-w-3xl text-4xl font-extrabold leading-tight md:text-6xl">Eye-care guidance and eyewear support, online and at home.</h1><p className="mt-6 max-w-2xl text-lg text-slate-300">Vision Vistara provides practical prescription guidance, selected-pincode home visits, and a dedicated online frames store. We do not operate a walk-in showroom.</p></div></section>
